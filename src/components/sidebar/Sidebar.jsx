...
export default function Sidebar() {
  ...
  const iconList = [
    {
      component: github,
      href: 'https://github.com/Herchan321'
    },
    {
      component: linkedin,
      href: 'www.linkedin.com/in/asma-herchan-a5497b22a'
    },
   
    {
      component: gmail,
      href: 'asmaherchan123@gmail.com'
    }
  ];
  const item = {
  ...
  return (
    <div className='sidebar'>
      ...
      >
        <img src={image} className='my-img' />
      </motion.div>
